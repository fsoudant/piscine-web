...
export const TOPICS = {
  ...
  ph:          { topic: `${BASE}/Piscine/PH`,            unit: '',       min: 6,   max: 9,  normLow: 7.0,  normHigh: 7.4  },
  redox:       { topic: `${BASE}/Piscine/Redox`,         unit: 'mV',     min: 0,   max: 800, normLow: 650,  normHigh: 750  },
  tac:         { topic: `${BASE}/Piscine/TAC`,           unit: 'ppm',    min: 0,   max: 200, normLow: 80,   normHigh: 120  },
  tds:         { topic: `${BASE}/Piscine/TDS`,           unit: 'ppm',    min: 0,   max: 2500,normLow: 250,  normHigh: 2000 },
  th:          { topic: `${BASE}/Piscine/TH`,            unit: 'ppm',    min: 0,   max: 300, normLow: 100,   normHigh: 250  },
  temperature: { topic: `${BASE}/Piscine/Temperature`,   unit: '°C',     min: -10, max: 45   },
  ...
  depression:  { topic: `${BASE}/Piscine/Depression`,    unit: 'bar',    min: -5, max: 0,   normLow: -5, normHigh: -3   },
