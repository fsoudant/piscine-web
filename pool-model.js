...
export const TOPICS = {
  ...
  ph:          { topic: `${BASE}/Piscine/PH`,            unit: '',       min: 0,   max: 14,   decimals: 1, step: 0.1,  normLow: 7.0,  normHigh: 7.4  },
  redox:       { topic: `${BASE}/Piscine/Redox`,         unit: 'mV',     min: 0,   max: 800,  decimals: 0, step: 1,    normLow: 650,  normHigh: 720  },
  tac:         { topic: `${BASE}/Piscine/TAC`,           unit: 'ppm',    min: 0,   max: 200,  decimals: 0, step: 1,    normLow: 80,   normHigh: 120  },
  tds:         { topic: `${BASE}/Piscine/TDS`,           unit: 'ppm',    min: 0,   max: 2000, decimals: 0, step: 1,    normLow: 250,  normHigh: 1500 },
  th:          { topic: `${BASE}/Piscine/TH`,            unit: 'ppm',    min: 0,   max: 300,  decimals: 0, step: 1,    normLow: 80,   normHigh: 200  },
  temperature: { topic: `${BASE}/Piscine/Temperature`,   unit: '°C',     min: -10, max: 45,   decimals: 1, step: 0.1,  normLow: 25,   normHigh: 30   },
  ...
  frequence:   { topic: `${BASE}/Piscine/Frequence`,     unit: 'Hz',     min: 0,   max: 50,   decimals: 1, step: 0.1   },
  ...
  depression:  { topic: `${BASE}/Piscine/Depression`,    unit: 'bar',    min: -50, max: 0,    decimals: 0, step: 1,    normLow: -50,  normHigh: -3   },
  ...
  freqBasse:   { topic: `${BASE}/Piscine/FreqBasse`,     unit: 'Hz',     min: 0,   max: 50,   decimals: 0, step: 1     },
  freqMoy:     { topic: `${BASE}/Piscine/FreqMoy`,       unit: 'Hz',     min: 0,   max: 50,   decimals: 0, step: 1     },
  freqHaute:   { topic: `${BASE}/Piscine/FreqHaute`,     unit: 'Hz',     min: 0,   max: 50,   decimals: 0, step: 1     },
  minFreqHaut: { topic: `${BASE}/Piscine/minFreqHaut`,   unit: 'min',    min: 0,   max: 59,   decimals: 0, step: 1     },
  etalonPh1:   { topic: `${BASE}/Piscine/EtalonPh1`,     unit: 'pH',     min: 0,   max: 14,   decimals: 1, step: 0.1   },
  etalonPh2:   { topic: `${BASE}/Piscine/EtalonPh2`,     unit: 'pH',     min: 0,   max: 14,   decimals: 1, step: 0.1   },
